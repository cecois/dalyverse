    ...
    return {
      ...
      poetry: {
        poems: [{
          ...
          "author": "Dalton Wilcox",
          "meta": "prem. CBB Seattle 2019 ~1:51:30",
          "stanzas": [{
              "lines": [
            ...
            { "lines": ["He said \"Folks think this building is an eyesore, blocking the view, just like this guy's cowboy hat,\" pointing at you-know-who."] }, {
              "lines": [
              ...
              "lines": [
                "A silver bullet between the eyes sent Caddy to the ground.", "I returned its lifeless body to the waters of The Sound.", "And now that I've killed that monster as only a Cowboy could.", "I'll admit saying 'Microsoft' as a way to describe a penis - that was pretty good."
              ]
            }
          ]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a Russian president name'a 'Putin'", "for whom no right-minded person was rootin.'"
            ]
          }, {
            "lines": [
              "He put us in fear", "and would never be named Irish Person of the Year.", "And he looks like the type of guy who's allergic to gluten."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "When goin online to buy clothes", "best go to the place e'ryone knows."
            ]
          }, {
            "lines": [
              "If you're union and a teamtress", "you won't need a seamstress.", "Because I hope Warby Parker, Bonobos, and LegalZoom is what you chose."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a coach name'a Taylor", "who watched footballs across a field that would sail her."
            ]
          }, {
            "lines": [
              "He loved football the most", "but would never go to the post.", "As he never wanted to use nothin' but stamps.com to mail her."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a Pope from the future.", "And if you were a sinner he'd boot yer."
            ]
          }, {
            "lines": [
              "He'd look you up and down", "and say with a frown,", "\"why, if you was a trumpet I'd toot ya.\""
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a locksmith named Bob.", "Who took locksmithing for a job."
            ]
          }, {
            "lines": [
              "He installed locks in a house.", "But he was a louse.", "So each house he locked up he would rob."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            ...
            "lines": [
              "But we've got to prevail.", "Use stamps.com to help with your mail.", "A limerick is more powerful than a gun."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "A great battle is being waged.", "In the Twilight Nether Realm is where it's staged."
            ]
          }, {
            "lines": [
              "Evil might win", "which would be a great sin.", "I tell you what - I really like that Greek yogurt by FAGE."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "I think you two guys are pricks.", "I think you two guys are dicks."
            ]
          }, {
            "lines": [
              "I came in here to tell stories", "about poor old Johnny McGorry.", "And it turns out that Nicole Kidman and her entire family were all ghosts."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "Happy 50th to Margaret and Ted.", "I thank god that neither is dead."
            ]
          }, {
            "lines": [
              "I've slept with you both", "despite your sacred oath.", "Turns out Rosebud was a sled."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a fella named Obama", "he was sad because of the cancer that killed his mama."
            ]
          }, {
            "lines": [
              "He wanted to make it better", "so he rolled up his sweater.", "And he handed it to Big Insurance and Pharma."
            ]
          }]
        }, {
          ...
          "stanzas": [{
            "lines": [
              "There once was a house that was dark", "and that is where I wanted to park."
            ]
          }, {
            "lines": [
              "She turned off the lights", "and it gave me a fright.", "Seriously, shut the fuckin lights off."
            ]
          }]
        }, {
          "_id": "lookoutbelowyoumighttwistyouranklebartlebymulcahey",
          "title": "Look Out Below - You Might Twist Your Ankle",
          "author": "Bartleby Mulcahey",
          "meta": "referenced on BFB#005 but unread",
          "stanzas": [{
            "lines": [
              ""
            ]
          ...
          "_id": "theregoesacactusandtheregoesyoubartlebymulcahey",
          "title": "There Goes a Cactus; And there Goes You",
          "author": "Bartleby Mulcahey",
          "meta": "referenced on BFB#005 but unread",
          "stanzas": [{
            "lines": [
          ...
          "_id": "iiveneverseenthesouthoffrancebartlebymulcahey",
          "title": "I've Never Seen the South of France",
          "author": "Bartleby Mulcahey",
          "meta": "prem. ADPPP 9 ~1:20:15",
          "stanzas": [{
            "lines": [
              "i've never seen the south of france", "nor a breakfast nook wearin pants"
            ]
          }]
        }, {
          "_id": "icanrelatetobonanzabartlebymulcahey",
          "title": "I Can Relate to Bonanza",
          "author": "Bartleby Mulcahey",
          "meta": "prem. ADPPP 9 ~1:17:45",
          "stanzas": [{
            "lines": [
              "there are many paths in life", "and some i've never took", "i've never seen the south of france", "nor have i seen a brook"
            ]
          }, {
            "lines": [
              "but of all the things i've never done", "along the paths in life", "the one i've missed the most", "is that i've never had a wife"
            ]
          }, {
            "lines": [
              "ben cartwright had three", "he'd see a woman and right away he'd choose her", "but though i've never had one", "at least i never had to lose her"
            ]
          }]
        }, {
          ...
          "stanzas": [{
              "lines": [
                "a true Cowboy of the american west", "doesn't need tv - he likes campfires best", "if he wants to watch some ranchers workin on the land", "he can look out his damn window and then go lend a hand"
              ]
            }, {
              "lines": [
                "but what about those ignorant city-slickin jackasses?", "how could Cowboys educate the stupid, stupid masses?", "bonanza! bonanza! bonanza! bonanza!", "a real, no bullshit, television extravaganza"
              ]
            }, {
              "lines": [
                "four real men livin on the ponderosa", "doin what they want to and doin what they're supposeda", "adam has a face but it aint too expressive", "hoss is a giant and that there is impressive"
              ]
            }, {
              "lines": [
                "little joe is pretty (too pretty if you ask me)", "but the cartwright i like best is ben - tough and fair and free", "he's a hell of a rancher and a real good dad", "and you'll regret it if you make him mad"
              ]
            }, {
              "lines": [
                "he's got more good qualities than a short poem can mention", "but there's one thing about him that's caught my attention", "ben cartwright has buried three wives", "because they died - something ended their lives"
              ]
            }, {
              "lines": [
                "the story goes that childbirth is the thing that killed the first", "the second died by indian (cuz indians are the worst)", "the third fell off a horse and was that way dismembered", "but except for ol ben cartwright there's no one else remembers"
              ]
            }, {
              "lines": [
                "no one else can tell the tales of how these women died", "is it possible that when ol ben cartwright said those things he lied?"
              ]
            }

            , {
              "lines": [
                "maybe his first wife was cursed by a mummy", "he'd'a shot her then cuz men aint no dummy", "maybe his second was a black lagoon creature", "he'd'a killed her, too - yep, that'd teach her"
              ]
            }, {
              "lines": [
                "the third one, a werewolf? who knows - you get the point", "the ponderosa's too nice a place to have monsters in the joint", "ben cartwright is smart - he puts safety before romance", "the type of guy who probly keeps a stake of wood down his pants"
              ]
            }, {
              "lines": ["which i do in case i'm gonna run into any vampires"]
            }
          ]
        }, {
          ...
          "_id": "ebenezerwilcoxreviseddaltonwilcox",
          "title": "Ebenezer Wilcox (Revised)",
          "author": "Dalton Wilcox",
          "meta": "revised Bananas for Bonanza S1E2 (Peecast Blast 2018) 262 ~52:45",
          "stanzas": [{
            "lines": [
              ...
              "i'd lost 20 head of cattle to a vampire attack",
              "and a mummy had been posing as my ranch-hand Bobby Jack"
            ]
          }, {
            "lines": [
              "i was feeling set-upon, overwhelmed, and very weary", "all of which is the opposite of feeling christmas cheery", "and i now what happens when a man feels this way", "when Christmas comes and he is not gay"
            ]
          }, {
            "lines": [
              "so i kept my ears out for those three christmas spirits",
              "if a ghost tried to come at me i'd damn surely hear it",
              "and sure enough: a ghost! a ghost! a ghost! a ghost! a ghost!",
              "the thing, next to vampires and mummies (and various other monsters) that a Cowboy fears the most"
            ]
          }, {
            "lines": [
              "it came a-haunting me about things in my past",
              "like the time i ran over a Mexican family cuz i was drunk-driving too fast",
              "yes he came in the form of sheriff Ben McBride",
              "saying 'Boo, come with me' and 'Vehicular homicide'",
            ]
          }, {
            "lines": [
              "this ghost had a warrant for the crime of 'Hit and Run'",
              "and he got the action-end of my Smith & Wesson gun",
              "i was tryin to bury him when the next ghost did appear",
              "the ghost of christmas of present in the form of Deputy Geare"
            ]
          }, {
            "lines": [
              "he had come to haunt me about burying Sheriff Ben",
              "so i hit him with a shovel and began to dig again",
              "the ghost of christmas future was a curious passer-by",
              "taking care of him was hard 'cause he seemed like a real nice guy"
            ]
          }, {
            "lines": [
              "but after that a strange thing happened - after all that stress and fear",
              "those Christmas ghosts had done their job - i was smiling ear to ear",
              "i told a boy to buy me the biggest goose in town",
              "he turned out to be a werecat so i had to gun him down"
            ]
          }, {
            "lines": [
              "but it's shaping up to be the greatest Christmas of them all", "so from the heart of the West comes a cheerful cry", "Merry Christmas, one and all"
            ]
          }]
        }, {
